<div class="box feed-new">
    <div class="box-body">
        <div class="feed-new-editor m-10 row">
            ...
            <div class="feed-new-input-placeholder">O que você está pensando, <?= $name[0]; ?>?</div>
            <div class="feed-new-input" contenteditable="true"></div>
            <div class="feed-new-photo">
                <img src="<?=$base;?>/assets/images/photo.png">
                <input class="feed-new-file" type="file" name="photo" accept="image/png,image/jpg,image/jpeg" />
            </div>
